...
// XXX
// - favicon…
// - registerProtocolHandler for this (check it works for localhost)
// - only parse URL if we're being loaded as the phandler
// - go the SW path here
// - this could work almost the same in an Electron app
